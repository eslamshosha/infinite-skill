...
$(document).ready(function () {
  ...
  if ($(window).width() < 991) {
    $(".services-section .swiper-containeres").addClass("swiper-container");
    $(".services-section .services-cont").addClass("swiper-wrapper");
    $(".services-section .swiper-slidees").addClass("swiper-slide");
    var services = new Swiper(".services-section .swiper-container", {
      loop: true,
      autoplay: true,
      slidesPerView: 2,
      spaceBetween: 15,
  ...
  ///////// **news-section** /////////
  var news = new Swiper(".news-section .swiper-container", {
    loop: true,
    autoplay: true,
    pagination: {
